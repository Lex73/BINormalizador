            	...
            	<?php
                  ...
                  echo '<td><os-p>'.$row->Ubicacion.'</os-p></td>';
                      if($visualizar== true)
                      {
                          echo '<td>
                                <os-p></os-p>
                                <a class="btn btn-xs btn-success  mitooltip" title="Ver registro" href="'.base_url().'Registros/ver/'.$row->IDPro.'"><i class="fa fa-binoculars"></i></a>
                                </td>';
                      }
		              echo '</tr>';
              		}
